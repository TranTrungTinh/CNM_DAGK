...
$('#sign_in').click(function (e) {
  ...
  $.post('/signin', { username: username, password: password }, function (resp) {
...
var userLat = null; // kinh do nguoi dung
var userLng = null; // vi do nguoi dung
...
var autoComplete = function autoComplete() {
    ...
    searchBox.addListener('places_changed', function () {
        ...
        var userAddress = places[0].formatted_address;
...
$('#phone').blur(function () {
    ...
    $.post('/history', { phone: phone }, function (resp) {
        $('.list-group').html('');
        if (resp.message) {
            var history = resp.history;

            history.forEach(function (e) {
                var content = '<li class="list-group-item list-group-item-info">' + e.address + '</li>';
                $('.list-group').append(content);
            });
        } else {
            var content = '<li class="list-group-item list-group-item-info">This phone isn\'t hitories</li>';
            $('.list-group').append(content);
        }
        $('#address').focus();
    });
...
$('#btn_order').click(function (e) {
    ...
    var vehicle = $('input[id=bike]:checked').val() ? true : false; // true: bike , flase: car
    var address = $('#address').val() || '';
    if (!phone) return swal("WARNING", "Vui lòng nhập số điện thoại", "warning");
    if (!address) return swal("WARNING", "Vui lòng chọn địa chỉ", "warning");
    var order = {
        phone: phone,
        address: address,
        lat: userLat,
    ...
    $.post('/order', order, function (resp) {
        if (resp.message) {
            userLat = null;
            userLng = null;
            return swal("SUCCESS", "Đặt xe thành công", "success");
        }
